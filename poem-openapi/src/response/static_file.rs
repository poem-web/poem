    ...
    fn meta() -> MetaResponses {
        MetaResponses {
            responses: vec![
                ...
                MetaResponse {
                    summary: None,
                    description: Some("Resource was not found"),
                    status: Some(404),
                    status_range: None,
                    content: vec![],
                    headers: vec![],
                ...
                MetaResponse {
                    summary: None,
                    description: Some("The Content-Range response HTTP header indicates where in a full body message a partial message belongs."),
                    status: Some(416),
                    status_range: None,
                    content: vec![],
                    headers: vec![],
