...
/// Request entity
///
/// Defined as a DTO which need to implement [`serde::Deserialize`] which would be deserialized from
/// request body
...
///
/// [`req: Json<CreateSomething>`] in input parameter would be the data schema of request.
/// The fields in request body can be more than we defined in data structure, but the ones other than
/// we defined in structure would be ignored
#[handler]
